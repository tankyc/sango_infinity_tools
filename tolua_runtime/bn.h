...
/* The choices are 1, 2 and 4 bytes in size with uint32, uint64 for WORD_SIZE==4, as temporary. */
  ...
  #define BN_ARRAY_MEMORY_SIZE   128 // 128*sizeof(DTYPE)
#elif (WORD_SIZE == 2)
  ...
  #define BN_ARRAY_MEMORY_SIZE   256 // 128*sizeof(DTYPE)
#elif (WORD_SIZE == 4)
  ...
  #define BN_ARRAY_MEMORY_SIZE   512 // 128*sizeof(DTYPE)
#endif
#ifndef DTYPE
...
void bignum_to_hex_string(struct bn* n, char* str, int maxsize);
...
void bignum_sub(struct bn* a, struct bn* b, struct bn* c, int* sign); /* c = a - b */
